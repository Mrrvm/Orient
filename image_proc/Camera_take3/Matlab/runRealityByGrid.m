function [plotAng, axisCount, eRoppr, eRfpro, eRmbpe, eRepog] = runRealityByGrid(filepath, samplePer, enoughPer, maxIters, maxErr, B,  radius, K)
...
[imgs1, imgs2, axisCount] = readImages(filepath);
