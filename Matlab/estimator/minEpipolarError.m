function [Rmee Tmee] = minEpipolarError(m1, m2, B, radius, K, eulinit)
...
[x,fval,exitflag,output] = fminsearch(@(x)objectiveFunMEE(x, m1, m2, B, K), eulinit, options);% Finit(:), options);
